package com.ExpreefyIT.FeedbackByEmtion.utils;
// Latest Version
...
public class SortingHelper {
    // function to sort Map in descending order by values of Emotion index
    public static <K, V extends Comparable> Map<K, V> sortByValues(Map<K, V> map) {
        ...
        // sorting 
        Collections.sort(mappings, (o1, o2) ->o1.getValue().compareTo(o2.getValue()));
